  ...
  <div>
    <v-stepper value="4">
      <v-stepper-header>
        ...
        <v-stepper-step color="#283593" step="3" complete>Scope</v-stepper-step>
    ...
    <h1>Selection in Order: {{$route.params.orderId}} and Scope: {{$route.params.scopeId}}</h1>
...
export default {
  ...
  methods: {
    getScopes() {
      let self = this;
      this.axios
        .post("http://localhost:3000/task/getByOrderAndScope", {orderId: this.orderId, scopeId: this.scopeId})
